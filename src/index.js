...
const ContractEditor = (props) => {
    var url = endURL+"/editor/edit?PK="+props?.publishKey+"&subAccountSID="+props?.subAccountSID+"&id="+props?.id+"&color="+props?.color+"&tags="+encodeURIComponent(JSON.stringify(props?.tags));
